...
const SITE_URL             = 'https://now.elvtsocial.xyz';
...
<div style="max-width:580px;margin:0 auto;padding:48px 20px;">
  ...
  <p style="font-size:11px;color:rgba(250,246,240,0.25);text-align:center;margin-top:28px;">
    ELVT Social · Apps on Purpose™ © 2026 · <a href="${SITE_URL}" style="color:rgba(201,169,110,0.4);text-decoration:none;">now.elvtsocial.xyz</a>
  </p>
</div>
</body></html>`
  });
