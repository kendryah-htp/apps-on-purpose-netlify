...
// Endpoint: https://elvtapp.netlify.app/.netlify/functions/stripe-webhook
// ═══════════════════════════════════════════════════════════
...
<div style="max-width:580px;margin:0 auto;padding:48px 20px;">
  ...
  <div style="background:#150F08;border:1px solid rgba(201,169,110,0.15);padding:40px;">
    ...
    <div style="text-align:center;margin:32px 0 24px;">
      <a href="https://elvtapp.netlify.app" style="display:inline-block;background:#C9A96E;color:#0E0A06;padding:16px 40px;text-decoration:none;font-weight:700;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;">Access Your Dashboard →</a>
    </div>
  ...
  <div style="text-align:center;margin-top:28px;">
    <p style="font-size:11px;color:rgba(250,246,240,0.25);margin:0;">ELVT Social — High Ticket Purpose &nbsp;·&nbsp; © 2026 &nbsp;·&nbsp; <a href="https://elvtapp.netlify.app" style="color:rgba(201,169,110,0.4);text-decoration:none;">elvtapp.netlify.app</a></p>
  </div>
</div>
</body></html>`
  });
